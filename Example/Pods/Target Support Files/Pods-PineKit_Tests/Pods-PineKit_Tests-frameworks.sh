...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PineKit_Tests/BSGridCollectionViewLayout.framework"
  install_framework "Pods-PineKit_Tests/BSImagePicker.framework"
  install_framework "Pods-PineKit_Tests/PineKit.framework"
  install_framework "Pods-PineKit_Tests/UIImageViewModeScaleAspect.framework"
fi
